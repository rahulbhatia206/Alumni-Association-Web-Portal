...
-->
    ...
    <div class="page-container">
		...
		<!-- END POWER OFF -->                    
              ...
              <div class="page-title"><a href="search.php">Alumni Search</a>&nbsp;&nbsp; > &nbsp;&nbsp; Alumni Details</div>                               
...
<br>
                  ...
                  <div class="row">
                  <div class="block">
                  <h4 align="left">Alumni Details </h4>
                  <div>
                    <div align="right">Contact :
                      <?php
					echo "&nbsp;<a href='mailto:$rw[17]'> <button class='btn btn-info btn-condensed'><i class='glyphicon glyphicon-phone-alt'></i></button></a>&nbsp;";
					 ?>
                    </div>
                  </div>
