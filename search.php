...
-->
    ...
    <div class="page-container">
		...
		<!-- END POWER OFF -->                    
              ...
              <div class="page-title">Alumni Search</div>                               
                  ...
                  <div class="row">
                    ...
                    <div class="panel panel-default">
                      <div class="panel-heading">
                        <h3 class="panel-title">Alumni List</h3>
                        	            <div class="form-group">
                                          
           	            </div>
                      </div>
                      <div class="panel-body">                        
                        <h5>Click on the Alumni's Name or his Profile Picture to see his details<br>
<br>
                        </h5>
	...
	<?php
	    include 'connect.php';
		$sql="select * from student where isDisabled!=1";
		$run=mysqli_query($con,$sql);
		$nor=mysqli_num_rows($run);
		if($nor==0)
		{
  		echo "<strong>No Alumni added yet.</strong>";
  		}
  		else
  		{
		...
		while($rw=mysqli_fetch_array($run,MYSQLI_NUM))
  		{
						echo "<tr>
						 <td width='20'>$sno</td>
						 <td>$rw[8]</td>
						 <td width='200'><a href='alumnidetails.php?id=$rw[0]'><img src='profilePic/$rw[20]' alt='&nbsp;&nbsp;Photo Not Available' style='max-width:75%;'></a></td>
						 <td><a href='alumnidetails.php?id=$rw[0]'>$rw[6]</a></td>
						 <td>$rw[13]</td>
						 ";
		$sno=$sno+1;
						

					echo "<td ><a href='alumnidetails.php?id=$rw[0]'><button type='button' class='btn btn-default'>View More Details</button></a>&nbsp;
						&nbsp;<a href='mailto:$rw[17]'> <button class='btn btn-info btn-condensed'><i class='glyphicon glyphicon-phone-alt'></i></button></a>&nbsp;
						 </td>
						</tr>";
